...
#include <linux/jhash.h> /* SpeedMod linux-2.4.20-nethashfix */
...
//int ip_rt_secret_interval	= 4320 * 60 * HZ; /* SpeedMod linux-2.4.20-nethashfix */
...
static struct timer_list rt_secret_timer; /* SpeedMod linux-2.4.20-nethashfix */
...
static unsigned int		rt_hash_rnd; /* SpeedMod linux-2.4.20-nethashfix */
...
/* SpeedMod linux-2.4.20-nethashfix */
...
static void SMP_TIMER_NAME(rt_run_flush)(unsigned long dummy)
{
	...
	get_random_bytes(&rt_hash_rnd, 4); /* SpeedMod linux-2.4.20-nethashfix */
...
//	printk("goal=%d\n", goal);
	...
	rt_secret_timer.function = rt_secret_rebuild; /* SpeedMod linux-2.4.20-nethashfix */
