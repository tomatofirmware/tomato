...
//		ei.length = ROUNDUP((si.freeram - (256 * 1024)), mi.erasesize);
	...
	// Add Netgear WNDR4000, WNDR3700v3, WNDR3400, WNDR3400v2, WNDR3400v3 - write real len and checksum (arrmo, Dec 21/13)
	char *tmp;
	char imageInfo[8];
	...
	case MODEL_WNDR3400v3:
		...
		// Note: For WNDR4000/WNDR3700v3/WNDR3400v2/WNDR3400v2, the target address (offset) inside Linux is 0x6FFFF8 (displayed by CFE when programmed via tftp)
