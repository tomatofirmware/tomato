...
<title>[<% ident(); %>] Pasmo: W czasie rzeczywistym</title>
...
<div id='rstats'>
	...
	<div id='bwm-controls'>
		<small>(okno 10 minutowe, przedział czasowy: 2 sekundy)</small><br>
		<br>
		Uśrednienie&nbsp;
			<a href='javascript:switchAvg(1)' id='avg1'>Wyłacz</a>,
...
<tr><td id='footer' colspan=2>
	<span id='warnwd' style='display:none'>Uwaga: brak aktywności przez 10 sekund, restartowanie...&nbsp;</span>
	<span id='dtime'></span>
