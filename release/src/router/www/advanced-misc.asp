...
<title>[<% ident(); %>] <% _("Advanced"); %>: <% _("Miscellaneous"); %></title>
...
createFieldTable('', [
	{ title: '<% _("Boot Wait Time"); %> *', name: 'wait_time', type: 'select', options: a, value: fixInt(nvram.wait_time, 3, 20, 3) },
	{ title: '<% _("WAN Port Speed"); %> *', name: 'wan_speed', type: 'select', options: [[0,'10Mb Full'],[1,'10Mb Half'],[2,'100Mb Full'],[3,'100Mb Half'],[4,'Auto']], value: nvram.wan_speed },
	null,
/* CTF-BEGIN */
	{ title: 'CTF (Cut-Through Forwarding)', name: 'f_ctf_disable', type: 'checkbox', value: nvram.ctf_disable != '1' },
	null,
/* CTF-END */
	{ title: '<% _("Enable Jumbo Frames"); %> *', name: 'f_jumbo_frame_enable', type: 'checkbox', value: nvram.jumbo_frame_enable != '0', hidden: !et1000 },
	{ title: '<% _("Jumbo Frame Size"); %> *', name: 'jumbo_frame_size', type: 'text', maxlen: 4, size: 6, value: fixInt(nvram.jumbo_frame_size, 1, 9720, 2000),
		suffix: ' <small><% _("Bytes"); %> (<% _("range"); %>: 1 - 9720; <% _("default"); %>: 2000)</small>', hidden: !et1000 }
]);
</script>
<br>
