...
<title>[<% ident(); %>] VPN：Aktywność PPTP</title>
...
dg.populate = function() {
	...
	for (i = list.length - 1; i >= 0; --i) {
		e = list[i];
		hangup = '<div id="div_'+e.pid+'"><a href="javascript:disconnect(\'div_'+e.pid + '\',' + e.pid + ')" title="Disconnect" id="pid_' + e.pid + '">Rozłącz</a></div>';
/* REMOVE-BEGIN */
//		this.insert(-1, e, [
...
dg.setup = function() {
	...
	this.headerSet(['Interfejs', 'Użytkownik', 'Połączony od', 'Adres IP VPN', 'Źródł. adres IP', 'Akcja']);
	this.populate();
	this.sort(1);
}
...
<div class='section-title'>Aktywność PPTP</div>
<div class='section'>
<table id='dev-grid' class='tomato-grid' cellspacing=0></table>
</div>
<div style="float:right;text-align:right">
&raquo; <a href="vpn-pptp-server.asp">Konfiguruj</a>
</div>
</td></tr>
