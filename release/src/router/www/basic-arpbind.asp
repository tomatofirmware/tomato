...
function verifyFields(focused, quiet){
	var j = E('_f_new_arpbind_enable').checked;
	E('_f_new_arpbind_only').disabled = !j;
}
...
<input type='hidden' name='_nextpage' value='basic-arpbind.asp'>
...
<div class='section-title'>Static ARP Binding</div>
<div class='section'>
	<script type='text/javascript'>
	createFieldTable('', [
		{ title: 'Enable ARP Binding', name: 'f_new_arpbind_enable', type: 'checkbox', value: nvram.new_arpbind_enable != '0' },
		{ title: 'Restrict unlisted', name: 'f_new_arpbind_only', type: 'checkbox', value: nvram.new_arpbind_only != '0' }
	]);
	</script>
<br>
...
<div class='section'>
<ul>
<li><b>Restrict unlisted</b> - Disable access from all other (unlisted) machines to this router</li>
</ul>
</div>
...
<script type='text/javascript'>arpg.setup();verifyFields(null,1);</script>
</body>
</html>
