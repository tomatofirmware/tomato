...
if (wl_sunit(uidx)<0) {
	...
	W('<div class=\'section-title\'>Zaawansowane ustawienia Wi-Fi dla ');
	...
	createFieldTable('', [
		{ title: 'Afterburner', name: 'wl'+u+'_afterburner', type: 'select', options: [['auto','Automatycznie'],['on','Włącz'],['off','Wyłącz *']],
			value: nvram['wl'+u+'_afterburner'] },
		{ title: 'AP Isolation', name: 'wl'+u+'_ap_isolate', type: 'select', options: [['0','Wyłącz *'],['1','Włącz']],
			value: nvram['wl'+u+'_ap_isolate'] },
		{ title: 'Authentication Type', name: 'wl'+u+'_auth', type: 'select',
			options: [['0','Automatycznie *'],['1','Shared Key']], attrib: at ? 'disabled' : '',
			value: at ? 0 : nvram['wl'+u+'_auth'] },
		{ title: 'Basic Rate', name: 'wl'+u+'_rateset', type: 'select', options: [['default','Domyślne *'],['12','1-2 Mbps'],['all','Wszystkie']],
			value: nvram['wl'+u+'_rateset'] },
		{ title: 'Beacon Interval', name: 'wl'+u+'_bcn', type: 'text', maxlen: 5, size: 7,
			suffix: ' <small>(zakres: 1 - 65535; domyślnie: 100)</small>', value: nvram['wl'+u+'_bcn'] },
		{ title: 'CTS Protection Mode', name: 'wl'+u+'_gmode_protection', type: 'select', options: [['off','Wyłącz *'],['auto','Automatycznie']],
			value: nvram['wl'+u+'_gmode_protection'] },
		{ title: 'Regulatory Mode', name: 'wl'+u+'_reg_mode', type: 'select',
			options: [['off', 'Wyłącz *'],['d', '802.11d'],['h', '802.11h']],
			value: nvram['wl'+u+'_reg_mode'] },
		{ title: 'Kraj / Region', name: 'wl'+u+'_country_code', type: 'select',
			options: wl_countries, value: nvram['wl'+u+'_country_code'] },
		{ title: 'Bluetooth Coexistence', name: 'wl'+u+'_btc_mode', type: 'select',
			options: [['0', 'Wyłącz *'],['1', 'Włącz'],['2', 'Preemption']],
			value: nvram['wl'+u+'_btc_mode'] },
		{ title: 'Distance / ACK Timing', name: 'f_wl'+u+'_distance', type: 'text', maxlen: 5, size: 7,
			suffix: ' <small>metrów</small>&nbsp;&nbsp;<small>(zakres: 0 - 99999; 0 = domyślnie)</small>',
				value: (nvram['wl'+u+'_distance'] == '') ? '0' : nvram['wl'+u+'_distance'] },
		{ title: 'DTIM Interval', name: 'wl'+u+'_dtim', type: 'text', maxlen: 3, size: 5,
			suffix: ' <small>(zakres: 1 - 255; domyślnie: 1)</small>', value: nvram['wl'+u+'_dtim'] },
		{ title: 'Fragmentation Threshold', name: 'wl'+u+'_frag', type: 'text', maxlen: 4, size: 6,
			suffix: ' <small>(zakres: 256 - 2346; domyślnie: 2346)</small>', value: nvram['wl'+u+'_frag'] },
		{ title: 'Frame Burst', name: 'wl'+u+'_frameburst', type: 'select', options: [['off','Wyłącz *'],['on','Włącz']],
			value: nvram['wl'+u+'_frameburst'] },
		{ title: 'HP', hidden: !hp || (uidx > 0) },
			{ title: 'Amplifier', indent: 2, name: 'wlx_hpamp' + (uidx > 0 ? uidx + '' : ''), type: 'select', options: [['0','Wyłącz'],['1','Włącz *']],
				value: nvram.wlx_hpamp != '0', hidden: !hp || (uidx > 0) },
			{ title: 'Enhanced RX Sensitivity', indent: 2, name: 'wlx_hperx' + (uidx > 0 ? uidx + '' : ''), type: 'select', options: [['0','Wyłącz *'],['1','Włącz']],
				value: nvram.wlx_hperx != '0', hidden: !hp || (uidx > 0) },
		{ title: 'Maximum Clients', name: 'wl'+u+'_maxassoc', type: 'text', maxlen: 3, size: 5,
			suffix: ' <small>(zakres: 1 - 255; domyślnie: 128)</small>', value: nvram['wl'+u+'_maxassoc'] },
		{ title: 'Multicast Rate', name: 'wl'+u+'_mrate', type: 'select',
			options: [['0','Automatycznie *'],['1000000','1 Mbps'],['2000000','2 Mbps'],['5500000','5.5 Mbps'],['6000000','6 Mbps'],['9000000','9 Mbps'],['11000000','11 Mbps'],['12000000','12 Mbps'],['18000000','18 Mbps'],['24000000','24 Mbps'],['36000000','36 Mbps'],['48000000','48 Mbps'],['54000000','54 Mbps']],
			value: nvram['wl'+u+'_mrate'] },
		{ title: 'Preamble', name: 'wl'+u+'_plcphdr', type: 'select', options: [['long','Długa *'],['short','Krótka']],
			value: nvram['wl'+u+'_plcphdr'] },
		{ title: '802.11n Preamble', name: 'wl'+u+'_mimo_preamble', type: 'select', options: [['auto','Automatycznie'],['mm','Tryb mieszany *'],['gf','Green Field'],['gfbcm','GF-BRCM']],
			value: nvram['wl'+u+'_mimo_preamble'], hidden: !nphy },
		{ title: 'Overlapping BSS Coexistence', name: 'wl'+u+'_obss_coex', type: 'select', options: [['0','Wyłącz *'],['1','Włącz']],
			value: nvram['wl'+u+'_obss_coex'], hidden: !nphy },
		{ title: 'RTS Threshold', name: 'wl'+u+'_rts', type: 'text', maxlen: 4, size: 6,
			suffix: ' <small>(zakres: 0 - 2347; domyślnie: 2347)</small>', value: nvram['wl'+u+'_rts'] },
		{ title: 'Receive Antenna', name: 'wl'+u+'_antdiv', type: 'select', options: [['3','Automatycznie *'],['1','A'],['0','B']],
			value: nvram['wl'+u+'_antdiv'] },
		{ title: 'Transmit Antenna', name: 'wl'+u+'_txant', type: 'select', options: [['3','Automatycznie *'],['1','A'],['0','B']],
			value: nvram['wl'+u+'_txant'] },
		{ title: 'Moc nadawania', name: 'wl'+u+'_txpwr', type: 'text', maxlen: 3, size: 5,
			suffix: hp ?
				' <small>mW (przed wzmocnieniem)</small>&nbsp;&nbsp;<small>(zakres: 1 - 251; domyślnie: 10)</small>' :
				' <small>mW</small>&nbsp;&nbsp;<small>(zakres: 0 - 400, rzeczywista max. wartość zależy od wybranego kraju)</small>',
	...
	{ title: 'Interference Mitigation', name: 'wl'+u+'_mitigation', type: 'select',
		...
		{ title: 'WMM', name: 'wl'+u+'_wme', type: 'select', options: [['auto','Automatycznie *'],['off','Wyłącz'],['on','Włącz']], value: nvram['wl'+u+'_wme'] },
		{ title: 'No ACK', name: 'wl'+u+'_wme_no_ack', indent: 2, type: 'select', options: [['off','Wyłącz *'],['on','Włącz']],
			value: nvram['wl'+u+'_wme_no_ack'] },
	{ title: 'APSD Mode', name: 'wl'+u+'_wme_apsd', indent: 2, type: 'select', options: [['off','Wyłącz'],['on','Włącz *']],
		value: nvram['wl'+u+'_wme_apsd'] },
	{ title: 'Przekierowanie rozgłaszania (MCast) do Wi-Fi', name: 'wl'+u+'_wmf_bss_enable', type: 'select', options: [['0','Wyłącz *'],['1','Włącz']],
