...
//	if (wl_ifaces.length > 1)
	...
	f = [
		...
		{ title: 'SSID', name: 'wl'+u+'_ssid', type: 'text', maxlen: 32, size: 34, suffix: ' <i>(for full compatibility use only ASCII characters, avoid symbols!)</i>', value: eval('nvram.wl'+u+'_ssid') },
