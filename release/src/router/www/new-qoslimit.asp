...
// <% nvram("new_qoslimit_enable,new_qoslimit_ibw,new_qoslimit_obw,new_qoslimit_rules,new_qoslimit_d_enable,new_qoslimit_d_dlr,new_qoslimit_d_dlc,new_qoslimit_d_ulr,new_qoslimit_d_ulc"); %>
...
<br>
<div class='section-title'>Default Class for unlisted IP's</div>
<script type='text/javascript'>
createFieldTable('', [
	{ title: 'Enable', name: 'f_new_qoslimit_d_enable', type: 'checkbox', value: nvram.new_qoslimit_d_enable != '0'},
