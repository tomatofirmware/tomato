...
// <% nvram("new_qoslimit_enable,new_qoslimit_ibw,new_qoslimit_obw,new_qoslimit_rules,new_qoslimit_d_enable,new_qoslimit_d_dlr,new_qoslimit_d_dlc,new_qoslimit_d_ulr,new_qoslimit_d_ulc,qos_enable,qos_obw,qos_ibw"); %>
...
<input type='hidden' name='_nextpage' value='qos-bwlimit.asp'>
...
<div id='bwlimit'>
	...
	<div class='section-title'>QoS - Bandwidth Limiter</div>
	<div class='section'>
		<script type='text/javascript'>
			createFieldTable('', [
				{ title: 'Enable Limiter', name: 'f_new_qoslimit_enable', type: 'checkbox', value: nvram.new_qoslimit_enable == '1' },
				{ title: 'Download Bandwidth', name: 'new_qoslimit_ibw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: ((nvram.new_qoslimit_ibw != '') ? nvram.new_qoslimit_ibw : nvram.qos_ibw) },
				{ title: 'Upload Bandwidth', name: 'new_qoslimit_obw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: ((nvram.new_qoslimit_obw != '') ? nvram.new_qoslimit_obw : nvram.qos_obw) }
			]);
		</script>
		<br>
...
<div class='note-disabledw' style='display:none' id='qoswarn'>
	<b>You have to disable standard QoS before enabling this method.</b><br><br>
