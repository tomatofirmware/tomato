...
W('<div class="note-disabled">Zablokowano pomiar pasma.</b><br><br><a href="admin-bwm.asp">Uruchom &raquo;</a></div>');
E('rstats').style.display = 'none';
}
else if (rstats_busy) {
W('<div class="note-warning">Program rstats nie odpowiada lub jest zajęty. Spróbuj przeładować za parę sekund.</div>');
}
}
function checkCstats()
{
if (nvram.cstats_enable != '1') {
W('<div class="note-disabled">Pomiar IP Traffic zablokowany.</b><br><br><a href="admin-iptraffic.asp">Uruchom &raquo;</a></div>');
E('cstats').style.display = 'none';
}
else if (cstats_busy) {
W('<div class="note-warning">Program cstats  nie odpowiada lub jest zajęty. Spróbuj przeładować za parę sekund.</div>');
}
}
var dateFormat = -1;
