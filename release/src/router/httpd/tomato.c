...
// nas-aria2
	{ "aria2_enable",			V_01			},
	{ "aria2_sleep",			V_RANGE(1,60)		},
	{ "aria2_check",			V_01			},
	{ "aria2_check_time",			V_RANGE(1,55)		},
	{ "aria2_binary",			V_LENGTH(0, 50)		},
	{ "aria2_binary_custom",		V_LENGTH(0,50)		},
	{ "aria2_custom",			V_TEXT(0,2048)		},
	{ "aria2_enable_rpc",			V_01			},
	{ "aria2_rpc_allow_origin_all",		V_01			},
	{ "aria2_rpc_listen_all",		V_01			},
	{ "aria2_rpc_listen_port",		V_TEXT(0,50)		},
	{ "aria2_event_poll",			V_LENGTH(0,50)		},
	{ "aria2_rpc_user",			V_LENGTH(0,50)		},
	{ "aria2_rpc_passwd",			V_LENGTH(0,50)		},
	{ "aria2_max_concurrent_downloads",	V_RANGE(1,100)		},
	{ "aria2_continue",			V_01			},
	{ "aria2_max_tries",			V_RANGE(0,9999)		},
	{ "aria2_retry_wait",			V_RANGE(0,3600)		},
	{ "aria2_max_connection_per_server",	V_RANGE(1,16)		},
	{ "aria2_min_split_size",		V_LENGTH(0,20)		},
	{ "aria2_split",			V_RANGE(1,100)		},
	{ "aria2_max_overall_download_limit",	V_TEXT(0,16)		},
	{ "aria2_max_download_limit",		V_TEXT(0,16)		},
	{ "aria2_max_overall_upload_limit",	V_TEXT(0,16)		},
	{ "aria2_max_upload_limit",		V_TEXT(0,16)		},
	{ "aria2_lowest_speed_limit",		V_TEXT(0,16)		},
	{ "aria2_referer",			V_TEXT(0,1024)		},
	{ "aria2_input_file",			V_LENGTH(0,50)		},
	{ "aria2_save_session",			V_LENGTH(0,50)		},
	{ "aria2_usb_enable",			V_01			},
	{ "aria2_dlroot",			V_LENGTH(0,50)		},
	{ "aria2_dir",				V_LENGTH(0,50)		},
	{ "aria2_disk_cache",			V_TEXT(0,16)		},
	{ "aria2_enable_mmap",			V_01			},
	{ "aria2_file_allocation",		V_LENGTH(0,20)		},
	{ "aria2_bt_enable_lpd",		V_01			},
	{ "aria2_bt_tracker",			V_LENGTH(0,256)		},
	{ "aria2_bt_max_peers",			V_RANGE(1,9999)		},
	{ "aria2_bt_require_crypto",		V_01			},
	{ "aria2_follow_torrent",		V_01			},
	{ "aria2_listen_port",			V_TEXT(0,50)		},
	{ "aria2_enable_dht",			V_01			},
	{ "aria2_dht_listen_port",		V_TEXT(0,50)		},
	{ "aria2_enable_peer_exchange",		V_01			},
	{ "aria2_user_agent",			V_LENGTH(0,64)		},
	{ "aria2_peer_id_prefix",		V_LENGTH(0,64)		},
	{ "aria2_seed_ratio",			V_LENGTH(0,9999)	},
	{ "aria2_force_save",			V_01			},
	{ "aria2_bt_hash_check_seed",		V_01			},
	{ "aria2_bt_seed_unverified",		V_01			},
	{ "aria2_bt_save_metadata",		V_01			},
	{ "aria2_save_session_interval",	V_RANGE(0,3600)		},
#endif //TCONFIG_ARIA2

#ifdef TCONFIG_GAEPROXY
	{ "gaeproxy_enable",			V_01			},
	{ "gaeproxy_sleep",			V_RANGE(1, 60)		},
	{ "gaeproxy_check",			V_01			},
	{ "gaeproxy_check_time",		V_RANGE(1, 55)		},
	{ "gaeproxy_binary",			V_LENGTH(0, 50)		},
	{ "gaeproxy_binary_custom",		V_LENGTH(0,50)		},
	{ "gaeproxy_listen_ip",			V_TEXT(0,24)		},
	{ "gaeproxy_listen_port",		V_PORT			},
	{ "gaeproxy_listen_web_username",	V_TEXT(0,50)		},
	{ "gaeproxy_listen_web_password",	V_TEXT(0,50)		},
	{ "gaeproxy_listen_username",		V_TEXT(0,50)		},
	{ "gaeproxy_listen_password",		V_TEXT(0,50)		},
	{ "gaeproxy_listen_transparent_enable",	V_01			},
	{ "gaeproxy_pac_enable",		V_01			},
	{ "gaeproxy_pac_file_enable",		V_01			},
	{ "gaeproxy_pac_file",			V_TEXT(0,256)		},
	{ "gaeproxy_pac_https_mode",		V_RANGE(0,2)		},
	{ "gaeproxy_gae_enable",		V_01			},
	{ "gaeproxy_gae_appid",			V_TEXT(0,512)		},
	{ "gaeproxy_gae_password",		V_TEXT(0,50)		},
	{ "gaeproxy_gae_listen",		V_PORT			},
	{ "gaeproxy_gae_profile",		V_TEXT(0,128)		},
	{ "gaeproxy_gae_max_threads",		V_RANGE(0,10)		},
	{ "gaeproxy_gae_fetch_mode",		V_RANGE(0,2)		},
	{ "gaeproxy_hosts_enable",		V_01			},
	{ "gaeproxy_hosts_crlf",		V_01			},
	{ "gaeproxy_hosts_crlf_rules",		V_TEXT(0,1024)		},
	{ "gaeproxy_hosts_dns",			V_TEXT(0,128)		},
	{ "gaeproxy_hosts_resolve",		V_TEXT(0,1024)		},
	{ "gaeproxy_autorange_enable",		V_01			},
	{ "gaeproxy_autorange_hosts",		V_TEXT(0,1024)		},
	{ "gaeproxy_autorange_rules",		V_TEXT(0,1024)		},
	{ "gaeproxy_autorange_maxsize",		V_RANGE(0,9999999)	},
	{ "gaeproxy_autorange_waitsize",	V_RANGE(0,9999999)	},
	{ "gaeproxy_autorange_bufsize",		V_RANGE(0,1024000)	},
	{ "gaeproxy_proxy_enable",		V_01			},
	{ "gaeproxy_proxy_host",		V_TEXT(0,24)		},
	{ "gaeproxy_proxy_port",		V_PORT			},
	{ "gaeproxy_proxy_username",		V_TEXT(0,50)		},
	{ "gaeproxy_proxy_password",		V_TEXT(0,50)		},
	{ "gaeproxy_useragent_enable",		V_01			},
	{ "gaeproxy_useragent_match",		V_TEXT(0,128)		},
	{ "gaeproxy_useragent_rules",		V_TEXT(0,128)		},
	{ "gaeproxy_useragent_string",		V_TEXT(0,256)		},
	{ "gaeproxy_autoupload_enable",		V_01			},
	{ "gaeproxy_autoupload_gmail",		V_TEXT(0,64)		},
	{ "gaeproxy_autoupload_password",	V_TEXT(0,50)		},
	{ "gaeproxy_paas_enable",		V_01			},
	{ "gaeproxy_paas_password",		V_TEXT(0,50)		},
	{ "gaeproxy_paas_listen",		V_PORT			},
	{ "gaeproxy_paas_fetchserver",		V_TEXT(0,512)		},
	{ "gaeproxy_paas_proxy_enable",		V_01			},
	{ "gaeproxy_paas_proxy",		V_TEXT(0,128)		},
	{ "gaeproxy_urlfetch_nofallback",	V_TEXT(0,1024)		},
