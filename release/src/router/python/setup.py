...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        if not self.cross_compile:
            ...
            # Added all of used modules' include and lib dirs.  bwq518
            add_dir_to_list(self.compiler.library_dirs, '/opt/brcm/K26/hndtools-mipsel-uclibc-4.2.4/lib')
            add_dir_to_list(self.compiler.library_dirs, '../bzip2')
            add_dir_to_list(self.compiler.library_dirs, '../libcurl/lib/.libs')
            add_dir_to_list(self.compiler.library_dirs, '../sqlite/.libs')
            add_dir_to_list(self.compiler.library_dirs, '../libstdc++/prebuilt')
            add_dir_to_list(self.compiler.library_dirs, '../zlib')
            add_dir_to_list(self.compiler.library_dirs, '../libcares/.libs')
            add_dir_to_list(self.compiler.library_dirs, '..libexpat/.libs')
            add_dir_to_list(self.compiler.library_dirs, '../openssl')
            add_dir_to_list(self.compiler.library_dirs, '../libev/.libs')
            add_dir_to_list(self.compiler.library_dirs, '../libreadline/shlib')
            add_dir_to_list(self.compiler.library_dirs, '../libncurses/lib')
            add_dir_to_list(self.compiler.library_dirs, '../libdb/build_unix/.libs')
            add_dir_to_list(self.compiler.include_dirs, '/opt/brcm/K26/hndtools-mipsel-uclibc-4.2.4/include')
            add_dir_to_list(self.compiler.include_dirs, '../bzip2')
            add_dir_to_list(self.compiler.include_dirs, '../libcurl/include')
            add_dir_to_list(self.compiler.include_dirs, '../sqlite')
            add_dir_to_list(self.compiler.include_dirs, '../zlib')
            add_dir_to_list(self.compiler.include_dirs, '../libcares')
            add_dir_to_list(self.compiler.include_dirs, '../libexpat/lib')
            add_dir_to_list(self.compiler.include_dirs, '../openssl/include')
            add_dir_to_list(self.compiler.include_dirs, '../libev')
            add_dir_to_list(self.compiler.include_dirs, '../libreadline')
            add_dir_to_list(self.compiler.include_dirs, '../libncurses/include')
            add_dir_to_list(self.compiler.include_dirs, '../libdb/build_unix')
            self.add_multiarch_paths()
        ...
        if not self.cross_compile:
            ...
            if mydir:
                ...
                # assume the dir of sqlite is ../sqlite  bwq518
                sqlite_inc_paths = [ os.path.join('..', 'sqlite') ]
        ...
        if sqlite_incdir:
            if not self.cross_compile:
                ...
                if mydir:
                    ...
                    sqlite_dirs_to_check = [ os.path.join(sqlite_incdir, '.libs') ]
