...
Module: NutUpsmonConf
 Parses /usr/local/nut/upsmon.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all notification messages
      > print /files/usr/local/nut/upsmon.conf/NOTIFYMSG

About: Configuration files
  This lens applies to /usr/local/nut/upsmon.conf. See <filter>.
*)
...
let upsmon_filter = ( incl "/usr/local/nut/upsmon.conf" )
			. Util.stdexcl
