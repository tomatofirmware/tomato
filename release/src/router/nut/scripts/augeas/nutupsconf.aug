...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all drivers used
      > print /files//usr/local/nut/ups.conf/*/driver

About: Configuration files
  This lens applies to /usr/local/nut/ups.conf. See <filter>.
*)
...
let ups_filter   = (incl "/usr/local/nut/ups.conf")
                . Util.stdexcl
