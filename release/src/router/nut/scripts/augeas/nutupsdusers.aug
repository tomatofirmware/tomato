(*
Module: NutUpsdUsers
 Parses /usr/local/nut/upsd.users
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all users granted to send commands to UPS
      > /files/usr/local/nut/upsd.users/fred/actions/SET

About: Configuration files
  This lens applies to /usr/local/nut/upsd.users. See <filter>.
*)
...
let upsd_users_filter = ( incl "/usr/local/nut/upsd.users" )
			. Util.stdexcl
