...
Module: NutUpsSchedConf
 Parses /usr/local/nut/upssched.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print the command script:
      > print /files/usr/local/nut/upssched.conf/CMDSCRIPT

About: Configuration files
  This lens applies to /usr/local/nut/upssched.conf. See <filter>.
*)
...
let upssched_filter = ( incl "/usr/local/nut/upssched.conf" )
			. Util.stdexcl
