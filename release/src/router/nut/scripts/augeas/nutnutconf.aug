...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print NUT MODE start-up configuration:
      > print /files/usr/local/nut/nut.conf/MODE

About: Configuration files
  This lens applies to /usr/local/nut/nut.conf. See <filter>.
*)
...
let nut_filter = ( incl "/usr/local/nut/nut.conf" )
			. Util.stdexcl
