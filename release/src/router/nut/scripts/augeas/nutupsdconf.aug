(*
Module: NutUpsdConf
 Parses /usr/local/nut/upsd.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all network interface upsd will listen to
      > print /files/usr/local/nut/upsd.conf/LISTEN

About: Configuration files
  This lens applies to /usr/local/nut/upsd.conf. See <filter>.
...
let upsd_filter = (incl "/usr/local/nut/upsd.conf")
		. Util.stdexcl
