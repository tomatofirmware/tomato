...
Module: NutUpssetConf
 Parses /usr/local/nut/upsset.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print the string declaring secured cgi directory:
      > print /files/usr/local/nut/upsset.conf/auth

About: Configuration files
  This lens applies to /usr/local/nut/upsset.conf. See <filter>.
*)
...
let upsset_filter = ( incl "/usr/local/nut/upsset.conf" )
                        . Util.stdexcl
