(*
Module: NutHostsConf
 Parses /usr/local/nut/hosts.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all monitored upsd
	> print /files/usr/local/nut/hosts.conf/MONITOR

About: Configuration files
  This lens applies to /usr/local/nut/hosts.conf. See <filter>.
*)
...
let hosts_filter = ( incl "/usr/local/nut/hosts.conf" )
                        . Util.stdexcl
